...
// ملاحظة مهمة: توليد تحليل المريض الكامل (JSON طويل، حتى 3000 رمز) قد
// يستغرق أكثر من 13 ثانية بسهولة حتى مع نموذج مدفوع — لهذا نمنحه مهلة أطول
// بكثير (55 ثانية) من مهلة gsRequest القياسية المستخدمة للقراءة/الكتابة
// العادية، وإلا يُقطَع الطلب قبل أن يكمل النموذج توليد الرد فيظهر
