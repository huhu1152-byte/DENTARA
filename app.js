...
// تقييم كل فيديو، تفسير سريري، متابعة... حتى 6000+ رمز بعد رفع الحد الأساسي)
// قد يستغرق أكثر من 110 ثانية بسهولة، فنمنحه مهلة أوسع بكثير (280 ثانية) —
// تبقى أقل من الحد الأقصى لتنفيذ Apps Script نفسه (~6 دقائق) بهامش أمان،
// وإلا يُقطَع الطلب من طرف العميل بينما النموذج والخادم لا يزالان يعملان
// فعليًا وينجزان الرد (ودُفعت كلفته أصلاً) فيظهر "Server request timed out"
