...
async function buildInstructionsSheet() {
    ...
    const instructions = (r.personalized_instructions || []).slice(0, 6);
    const P = CONFIG.PROJECT;
        ...
        <div class="is-cols">
            <div class="is-col-daily">
                ...
                ${instructions.map((ins, i) => `
                    <div class="is-item">
                        <div class="is-item-icon"><i class="fa-solid ${instructionIcon(ins.instruction_arabic)}"></i></div>
                        <div>
                            <b>${i + 1}. ${escapeHtml(ins.instruction_arabic || "")}</b>
