...
// تسجيل عامل خدمة بسيط: بعض المتصفحات (مثل Samsung Internet) ترفض تثبيت
// الموقع كتطبيق (تظهر رسالة "تعذّر تثبيت تطبيق الويب") إن لم يوجد عامل
// خدمة مسجَّل، حتى لو باقي شروط manifest.json مستوفاة بالكامل
