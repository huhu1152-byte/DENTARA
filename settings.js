...
// ======== الفيديوهات الخمسة الثابتة: تعرّف تلقائي من اسم الفيديو ========
// بدل ما تختار الطبيبة تصنيفًا يدويًا، النظام يقرأ عنوان الفيديو نفسه
// ويحدد تلقائيًا هل يطابق أحد الفيديوهات الخمسة القياسية أو لا (فيديو
// عام). الترتيب مهم: "Interdental Brush" لازم تُفحص قبل "brush" العامة
// حتى لا تُصنَّف غلط كفيديو تفريش أسنان.
function guessVideoKey(title) {
    const t = String(title || "").toLowerCase();
    if (/interdental|بين\s*الأسنان|بين\s*الاسنان/.test(t)) return "interdental_brush";
