...
const STR = {
    ...
    oralHygieneAids: { en: "Recommended Oral Hygiene Aids", ar: "أدوات العناية الفموية الموصى بها" },
    ...
    missingInformation: { en: "Information Needed From Dentist", ar: "معلومات ناقصة يحتاجها الطبيب" },
    ...
    noVideosForYou: { en: "No specific videos were matched for you this time. Ask your dentist at your next visit.",
                       ar: "لم تُخصَّص لك فيديوهات هذه المرة. اسألي طبيبك بالزيارة القادمة." },
    ...
    videoCategory:     { en: "Standard category (optional)", ar: "التصنيف الثابت (اختياري)" },
    videoCategoryHint: { en: "If the title clearly names one of the 5 standard topics (brushing, floss, mouthwash, tongue scraper, interdental brush), the AI's strict rule for that topic is applied automatically — no need to pick anything.",
                          ar: "إذا كان العنوان يذكر بوضوح أحد المواضيع الخمسة الثابتة (تفريش، خيط أسنان، غسول فم، كاشطة لسان، فرشاة ما بين الأسنان)، تُطبَّق القاعدة الصارمة لهذا الموضوع تلقائيًا — بدون أي اختيار يدوي." },
    videoCategoryNone:        { en: "General video (no fixed category)", ar: "فيديو عام (بدون تصنيف ثابت)" },
    videoCategoryToothbrushing: { en: "Toothbrushing Technique", ar: "تقنية تفريش الأسنان" },
    videoCategoryFloss:         { en: "Dental Floss", ar: "خيط الأسنان" },
    videoCategoryMouthwash:     { en: "Mouthwash", ar: "غسول الفم" },
    videoCategoryTongueScraper: { en: "Tongue Scraper", ar: "كاشطة اللسان" },
    videoCategoryInterdental:   { en: "Interdental Brush", ar: "فرشاة ما بين الأسنان" },
    ...
    openInstructionsSheet: { en: "Instructions Sheet", ar: "ورقة التعليمات" },
    ...
    badFormat:   { en: "The AI reply was not in a valid format after several attempts. Please retry.",
                   ar: "لم يرجع الذكاء الاصطناعي صيغة صالحة بعد عدة محاولات. أعد المحاولة." }
};
